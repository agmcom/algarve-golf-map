...
values
  ('Nevada Bob''s Golf – Silves', 'nevada-bobs-silves', 'Silves', 'west',
  ...
  ('Nevada Bob''s Golf – Alto Golf', 'nevada-bobs-alto-golf', 'Portimão', 'west',
  ...
  ('Nevada Bob''s Golf – Gramacho', 'nevada-bobs-gramacho', 'Carvoeiro', 'west',
  ...
  ('Nevada Bob''s Golf – Vale da Pinta', 'nevada-bobs-vale-da-pinta', 'Carvoeiro', 'west',
  ...
  ('Nevada Bob''s Golf – Quinta da Ria', 'nevada-bobs-quinta-da-ria', 'Vila Nova de Cacela', 'east',
